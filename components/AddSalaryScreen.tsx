...
//   // Helper to calculate the derived System Basic based on Monthly Salary input
//   const calculateSystemBasic = (amount: number, type: WageType) => {
//     if (!amount) return 0;
//     switch (type) {
//       case 'Monthly': return amount; // X = 1
//       case 'Daily': return amount / 30; // X = 30
//       case 'Per Hour Basis': return amount / 240; // X = 30 * 8
...
//   const currentSystemBasic = calculateSystemBasic(Number(salaryAmount), wageType);
...
//                 <option value="Per Hour Basis">Hourly</option>
//               </select>
...
//                 <label className="block text-xs text-gray-500">Monthly salary</label>
...
//                       placeholder="0.00"
//                       className="block w-full py-2.5 pl-7 pr-4 rounded-md border-none focus:ring-0 text-gray-900 font-semibold placeholder-gray-300 text-sm"
//                     />
//                 </div>
//              </div>
...
//              <div className="space-y-2">
//                 <label className="block text-xs text-gray-500">System Basic</label>
//                 <div className="relative bg-white rounded-md border border-gray-200">
//                     <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-medium text-sm">₹</span>
//                     <input
//                       type="text"
//                       disabled
//                       value={salaryAmount ? (Number(salaryAmount) === 0 ? '0.00' : (currentSystemBasic).toFixed(2)) : '0.00'}
//                       className="block w-full py-2.5 pl-7 pr-4 rounded-md border-none bg-transparent text-gray-500 font-medium text-sm"
//                     />
//                 </div>
//              </div>
//           </div>
...
// const PreviewModal: React.FC<PreviewModalProps> = ({ isOpen, onClose, onContinue, wageType, amount, systemBasic, isSubmitting }) => {
...
//            <span className="text-xs font-semibold text-blue-400 uppercase tracking-wide">Monthly</span>
//         </div>
...
//                <span className="text-gray-600 font-medium">System Basic</span>
//                <span className="text-gray-900 font-medium">{formatCurrency(systemBasic)}</span>
//             </div>
